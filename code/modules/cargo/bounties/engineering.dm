...
/datum/bounty/item/engineering/gas/hydrogen_tank
	...
	description = "Наш отдел исследований и разработок занимается разработкой более эффективных электрических батарей, использующих водород в качестве катализатора. Отправьте нам полный бак водорода."
...
/datum/bounty/item/engineering/emitter
	name = "Излучатель"
	description = "Мы думаем, что в конструкции излучателя вашей станции может быть дефект, основанный на огромном количестве отслоений, которые, похоже, видит ваш сектор. Отправьте нам один из ваших."
	reward = 100
